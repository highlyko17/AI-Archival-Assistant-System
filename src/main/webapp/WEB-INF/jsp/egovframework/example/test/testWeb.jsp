...
<body>
    ...
    <form method="post" enctype="multipart/form-data" id="uploadFormSummary">
        <fieldset>
            ...
            <p>
                <input type="submit" value="Execute" onclick="javascript: form.action='summarize-vid-mnv.do'" class="custom-button">
            </p>
        </fieldset>
    </form>
</div>
...
<div id="tag-extraction" class="tab-content">
    <form method="post" enctype="multipart/form-data" id="uploadFormTagExtraction">
        <fieldset>
            ...
            <p>
                <input type="submit" value="Execute" onclick="javascript: form.action='extract-tag-mnv.do'" class="custom-button">
            </p>
        </fieldset>
    </form>
</div>
    ...
    <form method="post" enctype="multipart/form-data" id="uploadFormTimestampExtraction">
        <fieldset>
            ...
            <p>
                ...
                <input type="button" value="Execute" onclick="submitTimestampForm()" class="custom-button">
            </p>
        </fieldset>
    </form>
</div>
